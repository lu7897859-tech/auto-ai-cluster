...
// Generate blog #18 HTML
const f = '18-alertmanager-2c4g-alerts.md';
const content = fs.readFileSync(path.join(BLOG, f), 'utf8');
const titleMatch = content.match(/^# (.+)/m);
const title = titleMatch ? titleMatch[1].trim() : 'Untitled';
const date = '2026-07-25';
const desc = 'Run Prometheus AlertManager on a 2C4G VPS with under 30 MB RAM. Integrate with Telegram (via n8n), email, and Grafana.';
...
<h1>${title}</h1>
<p><small>Published ${date} &middot; 12 min read</small></p>
...
fs.writeFileSync(path.join(BLOG, '18-alertmanager-2c4g-alerts.html'), html, 'utf8');
console.log('Generated HTML for blog #18');
