...
// Generate blog #22
const f = '22-selfhosted-vector-db-2c4g.md';
const content = fs.readFileSync(path.join(BLOG, f), 'utf8');
const titleMatch = content.match(/^# (.+)/m);
const title = titleMatch ? titleMatch[1].trim() : 'Untitled';
const date = '2026-08-03';
const desc = 'Add semantic search to your 2C4G AI cluster with Qdrant or Chroma. Minimal RAM, zero cloud dependency, and a working Docker Compose recipe.';
...
fs.writeFileSync(path.join(BLOG, '22-selfhosted-vector-db-2c4g.html'), html, 'utf8');
console.log('Generated HTML for blog #22');
