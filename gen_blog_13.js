...
// Process blog 13 only
const mdFiles = ['13-cicd-vps-autodeploy.md'];
...
for (const f of mdFiles) {
  ...
  const desc = 'Zero-downtime CI/CD pipeline for self-hosted AI clusters on a 2C4G VPS. GitHub Actions → SSH → Docker Compose. Complete tutorial with rollback, health checks & production checklist.';
...
<h1>${title}</h1>
<p><small>Published ${date} · 14 min read</small></p>
${tagHtml ? `<p>${tagHtml}</p>` : ''}
...
<script type="application/ld+json">${jsonld}</script>
  ...
  fs.writeFileSync(path.join(BLOG, '13-cicd-vps-autodeploy.html'), html, 'utf8');
  console.log('✅ Generated HTML for blog #13');
}
...
const allUrls = [
  ...
  ['https://lu7897859-tech.github.io/auto-ai-cluster/white-paper.html', today],
  ['https://lu7897859-tech.github.io/auto-ai-cluster/docs/blog/index.html', today],
  ['https://lu7897859-tech.github.io/auto-ai-cluster/payment/checkout.html', today],
  ['https://lu7897859-tech.github.io/auto-ai-cluster/payment/trial.html', today],
];
